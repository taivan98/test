...
const days = [
  ...
  },
  {
    ...
    blocks: [
      ["10:00", "10:30", [{ type: "MAIN_HALL", kindHr: "Program", kindEn: "Program", titleHr: "Otvorenje konferencije", titleEn: "Conference opening", speaker: "", room: "Konferencijska dvorana", capacity: null }]],
      ["10:30", "11:05", [{ type: "MAIN_HALL", kindHr: "Keynote", kindEn: "Keynote", titleHr: "The Future Memory Engineer", titleEn: "The Future Memory Engineer", speaker: "Julian Dziubinski", room: "Konferencijska dvorana", capacity: null }]],
      ...
      ["12:25", "12:35", [{ type: "MAIN_HALL", kindHr: "Dodjela nagrada", kindEn: "Awards", titleHr: "Najbolje HR prakse 2026 – male i srednje tvrtke", titleEn: "Best HR Practices 2026 – Small & Medium Companies", speaker: "", room: "Konferencijska dvorana", capacity: null }]],
      ["12:35", "13:05", [{ type: "MAIN_HALL", kindHr: "Keynote", kindEn: "Keynote", titleHr: "Elevating Your Performance from Being a 'Swimmer' to a 'Waterwalker'", titleEn: "Elevating Your Performance from Being a 'Swimmer' to a 'Waterwalker'", speaker: "James Michael Lafferty", room: "Konferencijska dvorana", capacity: null }]],
      ["14:00", "14:20", [{ type: "MAIN_HALL", kindHr: "Dodjela nagrada", kindEn: "Awards", titleHr: "Najbolje HR prakse 2026 – velike tvrtke", titleEn: "Best HR Practices 2026 – Large Companies", speaker: "", room: "Konferencijska dvorana", capacity: null }]],
      ["14:20", "14:50", [{ type: "MAIN_HALL", kindHr: "Stand-up", kindEn: "Stand-up", titleHr: "Smijeh, istina i HR realnost u jednom!", titleEn: "Laughter, truth and HR reality in one!", speaker: "Vlatko Štampar", room: "Konferencijska dvorana", capacity: null }]],
      ["14:50", "15:10", [{ type: "MAIN_HALL", kindHr: "Dodjela nagrada", kindEn: "Awards", titleHr: "Najbolje HR prakse 2026 – Enterprise kategorija", titleEn: "Best HR Practices 2026 – Enterprise Category", speaker: "", room: "Konferencijska dvorana", capacity: null }]],
    ],
  },
  {
